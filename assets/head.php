	<meta charset="utf-8" />
		...
		<link rel="apple-touch-icon" href="<? echo $images ?>touch-icon-iphone.png" />
		<link rel="apple-touch-icon" sizes="76x76" href="<? echo $images ?>touch-icon-ipad.png" />
		<link rel="apple-touch-icon" sizes="120x120" href="<? echo $images ?>touch-icon-iphone-retina.png" />
		<link rel="apple-touch-icon" sizes="152x152" href="<? echo $images ?>touch-icon-ipad-retina.png" />
		<link type="text/css" rel="stylesheet" href="<? echo $url ?>assets/css/fonts.css" media="all" />
